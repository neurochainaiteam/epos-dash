...
export default function BrandMark({ className = 'h-9 w-9', title = 'NeuroChain Ai' }) {
  return (
    ...
    >
      ...
      {/* Central spine */}
      <path d="M32 12v40" stroke="#05D7EE" strokeWidth="2.4" strokeLinecap="round" />

      {/* Circuit traces */}
      <path d="M32 22h-7v8h-6M32 34h-9M32 42h-6v-4" stroke="#05D7EE" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M32 26h8M32 36h7v6h5M32 18h6v6" stroke="#05D7EE" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
