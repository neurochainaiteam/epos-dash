    ...
    <div>
      ...
      <div className="space-y-4 p-5 sm:p-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            <Card className="p-6"><div className="text-xs text-muted-foreground">Entries</div><div className="mt-1 text-xl font-bold tabular-nums">{all.length}</div></Card>
            <Card className="p-6"><div className="flex items-center gap-1.5 text-xs text-destructive"><Trash2 className="h-3.5 w-3.5" />Waste cost</div><div className="mt-1 text-xl font-bold tabular-nums text-destructive">{gbp(total, { decimals: 2 })}</div></Card>
            <Card className="p-6"><div className="text-xs text-muted-foreground">Top reason</div><div className="mt-1 text-base font-bold">{byReason[0]?.[0] ?? 'N/A'}</div></Card>
            <Card className="p-6"><div className="flex items-center gap-1.5 text-xs text-muted-foreground"><Utensils className="h-3.5 w-3.5" />Costliest item</div><div className="mt-1 truncate text-base font-bold">{byRecipe[0]?.recipe ?? 'N/A'}</div></Card>
          </div>
        )}
